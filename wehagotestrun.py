...
#         funlist = (['ap_approval', 'ap_postApproval', 'ap_preApproval', 'ap_reApproval', 'ap_modifyApproval', 'ap_createArchive',
#                     'ap_approveDocumentArchive', 'ap_moveDocumentArchive', 'ap_deleteArchive', 'ap_approve', 'ap_reject', 'ap_enforcement',
#                     'ap_addDocumentForm','ap_approvebyUser', 'ap_rejectbyUser', 'ap_deleteDocumentForm'])
#         # 전자결재 세팅 보류
#         #del funlist[2:4]
#         for fun in funlist :
...
class WehagoRun_Mobile :
    ...
    def message(self, browser) :
        ...
        funlist = (['ms_sendMessage', 'ms_sendImportantMessage', 'ms_sendSecurityMessage', 'ms_sendReservationMessage', 'ms_replyMessage', 'ms_replyAllMessage',
                   'ms_forwardMessage', 'ms_resendMessage', 'ms_readMessage', 'ms_downloadFile', 'ms_readSecureMessage', 'ms_bookmark', 'ms_deleteReceiveMessage', 'ms_deleteSendMessage'])
        # pms, sms 같이 조회되서 제거,
        for i in funlist[:] :
    ...
    def short_message(self, browser) :
        print('message s')
        # funlist = serviceFunction('ms_')
        funlist = (['ms_sendMessage', 'ms_sendImportantMessage', 'ms_sendSecurityMessage', 'ms_sendReservationMessage', 'ms_replyMessage', 'ms_replyAllMessage',
                   'ms_forwardMessage', 'ms_resendMessage', 'ms_readMessage', 'ms_downloadFile', 'ms_readSecureMessage', 'ms_bookmark', 'ms_deleteReceiveMessage', 'ms_deleteSendMessage'])
    ...
    def accounts(self, browser) :
        ...
        #funlist = ['ac_createGroup', 'ac_modifyGroup' ,'ac_deleteGroup'] # 리뷰용
        for fun in funlist :
            serviceRun(browser, Android.Account(), fun)

    def short_accounts(self, browser) :
        print('accounts s')
        funlist = ['ac_registAccount', 'ac_modifyAccount']
        for fun in funlist :
            serviceRun(browser, Android.Account(), fun)

    def contacts(self, browser) :
        print('contacts s')
        funlist = (['ct_registerContacts', 'ct_registerContacts_add', 'ct_createGroup', 'ct_modifyGroup', 'ct_deleteGroup', 'ct_createSharedGroup', 'ct_modifySharedGroup',
    ...
    def short_contacts(self, browser) :
        print('contacts s')
        funlist = (['ct_registerContacts', 'ct_registerContacts_add', 'ct_createGroup', 'ct_modifyGroup', 'ct_deleteGroup', 'ct_createSharedGroup', 'ct_modifySharedGroup',
                   'ct_deleteSharedGroup', 'ct_contactExport', 'ct_contactImport', 'ct_organizeContact', 'ct_LinkSetting', 'ct_autosaveOnOff'])
        for fun in funlist :
    ...
    def schedule(self, browser) :
        print('schedule s')
        funlist = (['sc_createCalendar', 'sc_createSharedCalendar', 'sc_modifyCalendar', 'sc_deleteCalendar' ,'sc_registerSchedule1', 'sc_registerSchedule2' ,'sc_searchSchedule',
                    'sc_addComment', 'sc_modifySchedule', 'sc_deleteSchedule', 'sc_clickCalendar'])
        for fun in funlist :
            serviceRun(browser, Android.Schedule(), fun)

    def short_schedule(self, browser) :
        print('schedule s')
        funlist = (['sc_createCalendar', 'sc_createSharedCalendar', 'sc_modifyCalendar', 'sc_deleteCalendar' ,'sc_registerSchedule1', 'sc_registerSchedule2' ,'sc_searchSchedule',
                    'sc_addComment', 'sc_modifySchedule', 'sc_deleteSchedule', 'sc_clickCalendar'])
        for fun in funlist :
    ...
    def communication(self, browser) :
        print('communication s')
        funlist = (['cc_createGroupChat','cc_appendingLocalFile','cc_appendingCamera','cc_appendingWedriveFile','cc_appendingContacts','cc_sendChat','cc_searchChat','cc_copyChat',
                    'cc_commentChat','cc_reactionChat','cc_deleteChat','cc_downloadFileTab','cc_settingPrivateGroup','cc_settingPublicGroup','cc_favoriteConversation','cc_checkUserProfile','cc_setAsMaster','cc_exportUser','cc_leaveChatRoom','cc_createChat'])
        for fun in funlist :
            serviceRun(browser, Android.Communication(), fun)

    def short_communication(self, browser) :
        print('communication s')
        funlist = (['cc_createGroupChat','cc_appendingLocalFile','cc_appendingCamera','cc_appendingWedriveFile','cc_appendingContacts','cc_sendChat','cc_searchChat','cc_copyChat',
                    'cc_commentChat','cc_reactionChat','cc_deleteChat','cc_downloadFileTab','cc_settingPrivateGroup','cc_settingPublicGroup','cc_favoriteConversation','cc_checkUserProfile','cc_setAsMaster','cc_exportUser','cc_leaveChatRoom','cc_createChat'])
        for fun in funlist :
    ...
    def mail(self, browser) :
        print('mail s')
        funlist = (['ma_sendMail', 'ma_sendReservedMail', 'ma_sendSecureMail', 'ma_temporarySave', 'ma_individualTransfer', 'ma_sendMailLocalWedrive', 'ma_replyMail',
                    'ma_replyMailAll', 'ma_deliveryMail', 'ma_readProcessing', 'ma_deleteMail', 'ma_emptyTrash'])
        for fun in funlist :
            serviceRun(browser, Android.Mail(), fun)

    def short_mail(self, browser) :
        print('mail s')
        funlist = (['ma_sendMail', 'ma_sendReservedMail', 'ma_sendSecureMail', 'ma_temporarySave', 'ma_individualTransfer', 'ma_sendMailLocalWedrive', 'ma_replyMail',
                    'ma_replyMailAll', 'ma_deliveryMail', 'ma_readProcessing', 'ma_deleteMail', 'ma_emptyTrash'])
        for fun in funlist :
    ...
    def approval(self, browser) :
        print('approval s')
        funlist = (['enterApproval','ap_attendanceVacation','ap_attendanceVacationCancel','ap_attendanceExtensionWork','ap_attendanceBusinessTrip','ap_modifyApproval','ap_moveApprovalArchive','ap_commentApproval','ap_enforcement','ap_mobileReject','ap_mobileReview',
                    'ap_webApprove','ap_webReject','ap_webReview','ap_webDelete','ap_webPreApproval','ap_webPostApproval','ap_approveDocumentArchive','ap_moveDocumentArchive'])
        for fun in funlist :
            serviceRun(browser, Android.Approval(), fun)

    def short_approval(self, browser) :
        print('approval s')
        funlist = (['enterApproval','ap_attendanceVacation','ap_attendanceVacationCancel','ap_attendanceExtensionWork','ap_attendanceBusinessTrip','ap_modifyApproval','ap_moveApprovalArchive','ap_commentApproval','ap_enforcement','ap_mobileReject','ap_mobileReview',
                    'ap_webApprove','ap_webReject','ap_webReview','ap_webDelete','ap_webPreApproval','ap_webPostApproval','ap_approveDocumentArchive','ap_moveDocumentArchive'])
        for fun in funlist :
    ...
    def wehagoRun(self, browser, id, version, brand = None) :
        ...
        wehagotest.Common().set_wehagoBrand(version, brand, 1)
        # 초기화면
        Android.Login().initialScreen(browser)
        #로그인 테스트
        Android.Login().login(browser, id)
        # 시작하기 화면
        Android.Login().start(browser)
        print('login end')
        # #거래처 테스트
...
#         browser.get(getUrl('attendance', 1))
#         time.sleep(5)
#         funlist = ['at_settingWorkingGroup', 'at_assignmentWorkingGroup', 'at_vacationApplication',
#                    'at_vacationApplicationCancel', 'at_deleteWorkingGroup']
#         for fun in funlist :
#             serviceRun(browser, wehagotest.Attendance(), fun)
#
#     def dev_invoice(self, browser) :
